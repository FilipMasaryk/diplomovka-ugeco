...
export default function FavoritesScreen({ navigation }: any) {
  const [allOffers, setAllOffers] = useState<CreatorOfferCard[]>([]);
  ...
  const handleUnlike = async (offerId: string) => {
      ...
      >
        ...
        <View style={styles.cardContent}>
          <View style={styles.cardHeader}>
            ...
            >
              <Ionicons name="heart" size={24} color="#FF4D6A" />
            </TouchableOpacity>
          </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={styles.emptyText}>Žiadne obľúbené ponuky</Text>
        }
      />
